import{t as e}from"./supabase-C7rZ412s.js";import{n as t}from"./index-aYaWdVZD.js";var n={meta:{title:`Login Admin`},async render(n){let{data:{session:r}}=await e.auth.getSession();if(r){t(`/admin`);return}n.innerHTML=`
