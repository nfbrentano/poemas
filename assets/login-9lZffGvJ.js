import{o as e,r as t}from"./index-05tUdvTZ.js";var n={meta:{title:`Login Admin`},async render(n){let{data:{session:r}}=await e.auth.getSession();if(r){t(`/admin`);return}n.innerHTML=`
