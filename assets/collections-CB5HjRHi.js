import{s as e}from"./index-B8YbiMm1.js";import{n as t,t as n}from"./html-Ca31mHym.js";import{r,t as i}from"./filter-chips-m2kPnKil.js";import{t as a}from"./seo-BlITGSmq.js";var o={meta:{title:`Coleções e Sentimentos — Natanael Brentano`},async render(o,s={}){let c=s.tags?s.tags.split(`,`):[],l=s.cols?s.cols.split(`,`):[],u=c.length>0||l.length>0;a({title:`Coleções e Sentimentos — Natanael Brentano`,description:`Explore poemas organizados por séries temáticas e sentimentos.`,type:`website`}),o.innerHTML=`
