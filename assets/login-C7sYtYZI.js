import{t as e}from"./index-mEssQEaL.js";import{supabase as t}from"./supabase-Cmo813Sf.js";var n={meta:{title:`Login Admin`},async render(n){let{data:{session:r}}=await t.auth.getSession();if(r){e(`/admin`);return}n.innerHTML=`
