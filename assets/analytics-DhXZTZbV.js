import{i as e}from"./index-C-Khbs-6.js";function t(e,t=700,n=160){if(!e||e.length===0)return`<p style="color:var(--text-muted);font-family:var(--font-ui);font-size:0.85rem;">Sem dados para o período.</p>`;let r=Math.max(...e.map(e=>e.count),1),i=t-36-16,a=n-16-32,o=e.length,s=e=>36+e/(o-1||1)*i,c=e=>16+a-e/r*a,l=e.map((e,t)=>`${s(t)},${c(e.count)}`).join(` `),u=`36,${16+a} `+l+` ${s(o-1)},${16+a}`,d=Array.from({length:5},(e,t)=>{let n=Math.round(r/4*t),a=c(n);return`<line x1="36" y1="${a}" x2="${36+i}" y2="${a}" stroke="var(--border-subtle)" stroke-width="1"/>
