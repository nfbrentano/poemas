import{o as e}from"./index-BOIPSjjC.js";import{r as t,t as n}from"./filter-chips-CpQxpzwk.js";import{t as r}from"./seo-Cx_atl1Z.js";var i={meta:{title:`Coleções e Sentimentos — Natanael Brentano`},async render(i,a={}){let o=a.tags?a.tags.split(`,`):[],s=a.cols?a.cols.split(`,`):[],c=o.length>0||s.length>0;r({title:`Coleções e Sentimentos — Natanael Brentano`,description:`Explore poemas organizados por séries temáticas e sentimentos.`,type:`website`}),i.innerHTML=`
