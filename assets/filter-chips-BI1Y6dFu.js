import{n as e,o as t}from"./index-DRnHbcne.js";function n(e){return typeof e==`string`?e.trim().replace(/^(sentimento|sentimentos|tag de sentimento|tags de sentimento):/i,``).trim():``}function r(e){let t=n(e);return t?t.charAt(0).toUpperCase()+t.slice(1).toLowerCase():``}var i=null,a={async fetchMetadata(e=null){if(i)return{tags:i};let n=e;if(!n){let{data:e}=await t.from(`poems`).select(`tags`).eq(`status`,`published`);n=e}let a={};n?.forEach(e=>{(e.tags||[]).forEach(e=>{let t=r(e);t&&(a[t]=(a[t]||0)+1)})});let o=Object.keys(a).sort((e,t)=>a[t]-a[e]).slice(0,20);return o.length>0&&(i=o),{tags:o}},render(e=[]){return`
