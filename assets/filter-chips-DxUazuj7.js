import{_ as e,g as t,p as n,u as r}from"./vendor-firebase-BaoyJsfj.js";import{t as i}from"./index-Dxqa1yDI.js";import{db as a}from"./firebase-BH47X0HM.js";function o(e){return typeof e==`string`?e.trim().replace(/^(sentimento|sentimentos|tag de sentimento|tags de sentimento):/i,``).trim():``}function s(e){let t=o(e);return t?t.charAt(0).toUpperCase()+t.slice(1).toLowerCase():``}var c=null,l={async fetchMetadata(i=null){if(c)return{tags:c};let o=i;if(!o)try{let i=n(e(a,`poems`),t(`status`,`==`,`published`)),s=await r(i),c=[];s.forEach(e=>{let t=e.data();c.push({tags:t.tags})}),o=c}catch{o=[]}let l={};o?.forEach(e=>{(e.tags||[]).forEach(e=>{let t=s(e);t&&(l[t]=(l[t]||0)+1)})});let u=Object.keys(l).map(e=>({name:e,count:l[e]})).sort((e,t)=>t.count-e.count).slice(0,20);return u.length>0&&(c=u),{tags:u}},render(e=[]){return`
