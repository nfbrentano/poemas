import{r as e,s as t}from"./index-BWGE2Wiv.js";var n={meta:{title:`Login Admin`},async render(n){let{data:{session:r}}=await t.auth.getSession();if(r){e(`/admin`);return}n.innerHTML=`
