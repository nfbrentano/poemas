import{o as e,r as t}from"./index-9pmtF_30.js";function n(e){return typeof e==`string`?e.trim().replace(/^(sentimento|sentimentos|tag de sentimento|tags de sentimento):/i,``).trim():``}function r(e){let t=n(e);return t?t.charAt(0).toUpperCase()+t.slice(1).toLowerCase():``}var i=null,a={async fetchMetadata(t=null){if(i)return{tags:i};let n=t;if(!n){let{data:t}=await e.from(`poems`).select(`tags`).eq(`status`,`published`);n=t}let a={};n?.forEach(e=>{(e.tags||[]).forEach(e=>{let t=r(e);t&&(a[t]=(a[t]||0)+1)})});let o=Object.keys(a).sort((e,t)=>a[t]-a[e]).slice(0,20);return o.length>0&&(i=o),{tags:o}},render(e=[]){return`
