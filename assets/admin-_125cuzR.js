const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-xfdHRXAz.css"])))=>i.map(i=>d[i]);
import{_ as e,a as t,c as n,d as r,f as i,g as a,h as o,m as s,n as c,p as l,r as u,s as d,u as f,v as p}from"./vendor-firebase-BaoyJsfj.js";import{r as m,t as h}from"./index-Dxqa1yDI.js";import{db as g,getFirebaseAuth as _,getFirebaseFunctions as v,getFirebaseStorage as y}from"./firebase-BH47X0HM.js";import{n as b,r as x,t as S}from"./html-Ca31mHym.js";var C={auth:{getSession:async()=>{let e=await _();if(e.currentUser)try{localStorage.setItem(`has_admin_session`,`1`)}catch{}else try{localStorage.removeItem(`has_admin_session`)}catch{}return{data:{session:e.currentUser}}},signOut:async()=>{await(await _()).signOut();try{localStorage.removeItem(`has_admin_session`)}catch{}}},from:t=>({select:n=>{let o=e(g,t),s=[],c=!1,u={eq:(e,t)=>(s.push(a(e,`==`,t)),u),gte:(e,t)=>(s.push(a(e,`>=`,t)),u),order:(e,t)=>(s.push(i(e,t?.ascending?`asc`:`desc`)),u),limit:e=>(s.push(r(e)),u),single:()=>(c=!0,u),then:async(e,t)=>{try{let t=l(o,...s),n=(await f(t)).docs.map(e=>({id:e.id,...e.data()}));if(c)return n.length===0?e({data:null,error:null}):e({data:n[0],error:null});e({data:n,error:null})}catch(t){e({data:null,error:t})}}};return u},insert:async n=>{try{let r=Array.isArray(n)?n:[n],i=[];for(let n of r){let r;n.id?(r=p(g,t,n.id),await s(r,n)):r=await d(e(g,t),n),i.push({id:r.id,...n})}let a=Array.isArray(n)?i:i[0];return{data:a,error:null,select:()=>({single:async()=>({data:a,error:null})})}}catch(e){return{error:e}}},update:e=>({eq:async(n,r)=>{if(n===`id`)try{return await o(p(g,t,r),e),{error:null}}catch(e){return{error:e}}return{error:Error(`Adapter only supports update by id`)}}}),delete:()=>({eq:async(r,i)=>{if(r===`id`)try{return await n(p(g,t,i)),{error:null}}catch(e){return{error:e}}if(t===`collection_poems`&&r===`collection_id`)try{let r=l(e(g,`collection_poems`),a(`collection_id`,`==`,i)),o=await f(r);return await Promise.all(o.docs.map(e=>n(p(g,t,e.id)))),{error:null}}catch(e){return{error:e}}return{error:Error(`Adapter only supports delete by id or collection_id`)}}})}),storage:{from:e=>({upload:async(t,n,r)=>{try{let r=await y(),i=c(r,`${e}/${t}`);return await u(i,n),{data:{path:t},error:null}}catch(e){return{error:e}}},getPublicUrl:t=>({data:{publicUrl:`https://firebasestorage.googleapis.com/v0/b/poemas-natanael.firebasestorage.app/o/${encodeURIComponent(e+`%2F`+t)}?alt=media`}})})},functions:{invoke:async(e,n)=>{try{let r=await v();return{data:(await t(r,e)(n?.body)).data,error:null}}catch(e){return{error:e}}}},rpc:async()=>({data:null,error:null})};function w(e,t){let n;return function(...r){clearTimeout(n),n=setTimeout(()=>e.apply(this,r),t)}}var T={meta:{title:`Dashboard Admin`},async render(e,t){let n=new URLSearchParams(window.location.search),r=n.get(`bypass_auth`)===`true`,{data:{session:i}}=await C.auth.getSession();if(!i&&!r){h(`/login`);return}let a=n.get(`view`)||`dashboard`,o=e=>{let t=a===e;return`font-size: 0.85rem; padding: 0.5rem 1rem; color: ${t?`var(--accent-subtle)`:`var(--text-secondary)`}; font-weight: ${t?`500`:`400`}; transition: color var(--transition-fast); border-bottom: 2px solid ${t?`var(--accent-subtle)`:`transparent`}; padding-bottom: 0.25rem; text-decoration: none;`};e.innerHTML=`
      <div class="admin-layout" style="max-width: 1400px; margin: 0 auto; padding: 0 var(--space-md); width: 100%; box-sizing: border-box;">
        <header style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: var(--space-xl); padding-bottom: var(--space-md); border-bottom: 1px solid var(--border-subtle); flex-wrap: wrap; gap: var(--space-md);">
          ...
          <div style="display: flex; gap: var(--space-xs); align-items: center; font-family: var(--font-ui); flex-wrap: wrap;">
            <a href="/admin?view=dashboard" data-link style="${o(`dashboard`)}">Início</a>
            <a href="/admin?view=list" data-link style="${o(`list`)}">Obras</a>
            <a href="/admin?view=collections" data-link style="${o(`collections`)}">Coleções</a>
            <a href="/admin?view=analytics" data-link style="${o(`analytics`)}">Estatísticas</a>
            <a href="/admin?view=emails" data-link style="${o(`emails`)}">Histórico de Emails</a>
            <a href="/admin?view=subscribers" data-link style="${o(`subscribers`)}">Assinantes</a>
            <a href="/admin?view=comments" data-link style="${o(`comments`)}">Comentários</a>
            <a href="/admin?view=editor" data-link style="font-size: 0.85rem; padding: 0.5rem 1rem; border: 1px solid var(--border-strong); border-radius: 2px; transition: border-color var(--transition-fast); text-decoration: none; color: var(--text-primary);">Nova Obra</a>
        ...
        <div style="font-family: var(--font-ui); display: grid; gap: var(--space-lg); width: 100%;">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: var(--space-sm);">
            ...
            <div style="display: flex; gap: var(--space-xs); flex-wrap: wrap;">
              <a href="/admin?view=editor" data-link style="padding: 0.5rem 1rem; background: var(--accent-subtle); color: var(--bg-primary); border-radius: 2px; font-weight: 500; font-size: 0.85rem; text-decoration: none; transition: opacity var(--transition-fast);" onmouseover="this.style.opacity=0.85" onmouseout="this.style.opacity=1">+ Nova Obra</a>
              <a href="/admin?view=collections" data-link style="padding: 0.5rem 1rem; border: 1px solid var(--border-strong); border-radius: 2px; font-size: 0.85rem; text-decoration: none; color: var(--text-primary); transition: background-color var(--transition-fast);" onmouseover="this.style.backgroundColor='var(--border-subtle)'" onmouseout="this.style.backgroundColor='transparent'">Coleções</a>
              <a href="/admin?view=comments" data-link style="padding: 0.5rem 1rem; border: 1px solid var(--border-strong); border-radius: 2px; font-size: 0.85rem; text-decoration: none; color: var(--text-primary); transition: background-color var(--transition-fast);" onmouseover="this.style.backgroundColor='var(--border-subtle)'" onmouseout="this.style.backgroundColor='transparent'">Comentários</a>
              <a href="/admin?view=analytics" data-link style="padding: 0.5rem 1rem; border: 1px solid var(--border-strong); border-radius: 2px; font-size: 0.85rem; text-decoration: none; color: var(--text-primary); transition: background-color var(--transition-fast);" onmouseover="this.style.backgroundColor='var(--border-subtle)'" onmouseout="this.style.backgroundColor='transparent'">Estatísticas</a>
            </div>
          </div>
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: var(--space-md); width: 100%;">
            ...
            <a href="/admin?view=analytics" id="visits-kpi-card" data-link style="position: relative; background: var(--bg-elevated); padding: var(--space-md); border-radius: 4px; border: 1px solid var(--border-subtle); display: flex; flex-direction: column; justify-content: space-between; min-height: 110px; height: auto; box-sizing: border-box; text-decoration: none; transition: border-color var(--transition-fast);" onmouseover="this.style.borderColor='var(--border-strong)'" onmouseout="this.style.borderColor='var(--border-subtle)'">
            ...
            <div style="background: var(--bg-elevated); border: 1px solid var(--border-subtle); border-radius: 4px; padding: var(--space-md); display: flex; flex-direction: column; justify-content: space-between;">
              <div>
                <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: var(--space-sm); border-bottom: 1px solid var(--border-subtle); padding-bottom: var(--space-2xs);">
                  ...
                  <a href="/admin?view=subscribers" data-link style="font-size: 0.75rem; color: var(--accent-subtle); text-decoration: none;">Ver todos</a>
                </div>
            ...
            <div style="background: var(--bg-elevated); border: 1px solid var(--border-subtle); border-radius: 4px; padding: var(--space-md); display: flex; flex-direction: column; justify-content: space-between;">
              <div>
                <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: var(--space-sm); border-bottom: 1px solid var(--border-subtle); padding-bottom: var(--space-2xs);">
                  ...
                  <a href="/admin?view=list" data-link style="font-size: 0.75rem; color: var(--accent-subtle); text-decoration: none;">Ver obras</a>
                </div>
          ...
          `;return}s.innerHTML=e.map(e=>{let t=a[e.id]||0,n=``;n=e.status===`scheduled`?`Agendado • ${new Date(e.scheduled_at).toLocaleString(`pt-BR`,{dateStyle:`short`,timeStyle:`short`})}`:e.status===`published`?`Publicado • ${new Date(e.published_at).toLocaleDateString(`pt-BR`)}`:`Criado • ${new Date(e.created_at).toLocaleDateString(`pt-BR`)}`;let r=e.status===`published`?`var(--success)`:e.status===`scheduled`?`var(--accent-subtle)`:`var(--border-strong)`,i=e.status===`published`?`var(--success)`:e.status===`scheduled`?`var(--accent-subtle)`:`var(--text-muted)`;return`
            <tr style="border-bottom: 1px solid var(--border-subtle); transition: background-color var(--transition-fast);">
              ...
              <td style="padding: var(--space-md) 0; text-align: right; font-family: var(--font-ui);">
                <a href="/admin?view=editor&id=${e.id}" data-link style="color: var(--text-primary); margin-right: var(--space-md); font-size: 0.85rem; transition: color var(--transition-fast); text-decoration: none;">Editar</a>
        ...
        <div class="editor-layout">
          <div class="editor-pane">
            ...
            <div style="display: flex; justify-content: flex-end; gap: var(--space-md); margin-top: var(--space-lg); border-top: 1px solid var(--border-subtle); padding-top: var(--space-lg);">
              <a href="/admin" data-link class="btn-secondary" style="padding: 0.75rem 1.5rem; color: var(--text-secondary);">Cancelar</a>
    ...
    `;let r=document.getElementById(`poem-title`),i=document.getElementById(`poem-slug`);r.addEventListener(`input`,()=>{if(document.getElementById(`preview-title`).textContent=r.value||`Título da Obra`,!t||i.value===``){let e=r.value.toLowerCase().trim().replace(/[áàãâä]/g,`a`).replace(/[éèêë]/g,`e`).replace(/[íìîï]/g,`i`).replace(/[óòõôö]/g,`o`).replace(/[úùûü]/g,`u`).replace(/ç/g,`c`).replace(/[^a-z0-9\s-]/g,``).replace(/\s+/g,`-`).replace(/-+/g,`-`).replace(/^-|-$/g,``);i.value=e}});let a=document.getElementById(`poem-content-input`),o=document.getElementById(`preview-content`),s=document.getElementById(`poem-tags`),c=document.getElementById(`poem-status`),l=document.getElementById(`scheduling-fields`);a.addEventListener(`input`,w(()=>{o.textContent=a.value},250)),s.addEventListener(`input`,w(()=>{let e=s.value.split(`,`).map(e=>e.trim()).filter(e=>e),t=document.getElementById(`preview-tags-container`);if(t&&(t.replaceChildren(),e.length>0)){let n=document.createElement(`span`);n.textContent=`•`;let r=document.createElement(`span`);r.textContent=`Sentimentos: ${e.join(`, `)}`,t.append(n,` `,r)}},250)),c.addEventListener(`change`,()=>{l.style.display=c.value===`scheduled`?`block`:`none`});let u=document.getElementById(`poem-audio-file`),d=document.getElementById(`poem-audio-url`),f=document.getElementById(`audio-upload-status`),p=document.getElementById(`audio-preview-container`),m=document.getElementById(`audio-preview-player`),g=document.getElementById(`audio-file-name`),_=document.getElementById(`remove-audio-btn`);u&&u.addEventListener(`change`,async e=>{let t=e.target.files?.[0];if(!t)return;let n=[`.mp3`,`.wav`,`.m4a`,`.aac`,`.ogg`],r=`.`+t.name.split(`.`).pop().toLowerCase();if(!n.includes(r)&&!t.type.startsWith(`audio/`)){alert(`Formato de áudio inválido. Por favor selecione um arquivo .mp3, .wav, .m4a ou .aac.`),u.value=``;return}let i={".m4a":`audio/mp4`,".mp3":`audio/mpeg`,".wav":`audio/wav`,".aac":`audio/aac`,".ogg":`audio/ogg`}[r]||t.type||`audio/mpeg`;if(t.size>10485760){alert(`O arquivo de áudio excede o tamanho máximo de 10MB.`),u.value=``;return}f.textContent=`Enviando áudio...`,f.style.color=`var(--accent-subtle)`,u.disabled=!0;try{let e=`narration_${Date.now()}${r}`,n=await C.storage.from(`audios`).upload(e,t,{contentType:i,upsert:!0}),a=`audios`;if(n.error&&(console.warn(`Bucket audios retornou erro, tentando fallback para avatars:`,n.error),n=await C.storage.from(`avatars`).upload(e,t,{contentType:i,upsert:!0}),a=`avatars`),n.error)throw n.error;let{data:o}=C.storage.from(a).getPublicUrl(e),s=o.publicUrl;d.value=s,m.src=b(s),m.load(),g.textContent=t.name,p.style.display=`flex`,_.style.display=`inline-block`,f.textContent=`Áudio carregado!`,f.style.color=`var(--success)`}catch(e){console.error(`Erro no upload de áudio:`,e),f.textContent=`Erro no envio`,f.style.color=`var(--error)`,alert(`Erro ao enviar áudio: `+(e.message||`Falha de conexão`))}finally{u.disabled=!1,u.value=``,setTimeout(()=>{f&&(f.textContent=``)},3500)}}),_&&_.addEventListener(`click`,()=>{confirm(`Deseja realmente remover o áudio desta poesia?`)&&(d.value=``,m.pause(),m.removeAttribute(`src`),m.load(),p.style.display=`none`,_.style.display=`none`,g.textContent=``,f.textContent=`Áudio removido.`,f.style.color=`var(--text-muted)`,setTimeout(()=>{f&&(f.textContent=``)},2500))});let v=()=>{let e=s.value.split(`,`).map(e=>e.trim()).filter(e=>e),t=document.getElementById(`scheduled-at`);return{title:document.getElementById(`poem-title`).value,slug:document.getElementById(`poem-slug`).value,content:document.getElementById(`poem-content-input`).value,excerpt:document.getElementById(`poem-excerpt`).value,tags:e,audio_url:d&&d.value.trim()||null,status:document.getElementById(`poem-status`).value,scheduled_at:t.value?new Date(t.value).toISOString():null}};document.getElementById(`editor-form`).addEventListener(`submit`,async e=>{e.preventDefault();let r=document.getElementById(`save-btn`);r.innerText=`Salvando...`,r.disabled=!0;let i=v();if(i.status===`scheduled`&&!i.scheduled_at){alert(`Por favor, defina uma data para o agendamento.`),r.innerText=`Gravar Alterações`,r.disabled=!1;return}i.status===`published`&&n.status!==`published`&&(i.published_at=new Date().toISOString());let a=null;if(t?a=(await C.from(`poems`).update(i).eq(`id`,t)).error:(i.created_at=new Date().toISOString(),a=(await C.from(`poems`).insert([i])).error),a){console.error(a),alert(`Erro ao salvar: `+a.message),r.innerText=`Gravar Alterações`,r.disabled=!1;return}h(`/admin`)});let y=document.getElementById(`publish-btn`);if(y){let e=!1;y.addEventListener(`click`,async n=>{if(n.preventDefault(),!document.getElementById(`editor-form`).reportValidity())return;if(!e){y.innerText=`Tem certeza? Clique para confirmar.`,y.style.background=`var(--error)`,e=!0,setTimeout(()=>{y&&!y.disabled&&(y.innerText=`Publicar e Notificar Assinantes`,y.style.background=`var(--success)`,e=!1)},4e3);return}y.innerText=`Publicando...`,y.disabled=!0;let r=v();r.status=`published`,r.published_at=new Date().toISOString();let i=t,a=null;if(t)a=(await C.from(`poems`).update(r).eq(`id`,t)).error;else{r.created_at=new Date().toISOString();let e=await C.from(`poems`).insert(r);a=e.error,e.data&&(i=e.data.id)}if(a){console.error(a),alert(`Erro ao publicar: `+a.message),y.innerText=`Publicar e Notificar Assinantes`,y.disabled=!1;return}if(i)try{y.innerText=`Enviando newsletter...`;let{data:e,error:t}=await C.functions.invoke(`sendNewsletter`,{body:{poemId:i}});if(t)throw t;alert(`Obra publicada e newsletter enviada com sucesso para ${e.count} assinantes!`)}catch(e){console.error(`Newsletter erro:`,e);let t=``;if(e.context&&typeof e.context.json==`function`)try{let n=await e.context.json();t=n.error||n.message||``}catch{}alert(`Obra publicada, mas houve um erro ao enviar a newsletter:\n${t||e.message||`Erro na Edge Function`}`)}h(`/admin`)})}},async renderEmailHistory(e){e.innerHTML=`<div class="loading">Carregando histórico e dados...</div>`;try{let[t,n]=await Promise.all([C.from(`email_campaign_logs`).select(`id, created_at, sent_at, status, details, poem_id, poems(title)`).order(`created_at`,{ascending:!1}),C.from(`poems`).select(`id, title`).eq(`status`,`published`)]);if(t.error)throw t.error;if(n.error)throw n.error;let r=t.data||[],i=n.data||[];i.sort((e,t)=>e.title.localeCompare(t.title)),r.forEach(e=>{let t=i.find(t=>t.id===e.poem_id);t&&!e.poems&&(e.poems={title:t.title}),e.created_at&&typeof e.created_at.toDate==`function`?e.created_at=e.created_at.toDate().toISOString():e.created_at&&e.created_at.seconds&&(e.created_at=new Date(e.created_at.seconds*1e3).toISOString()),e.sent_at&&typeof e.sent_at.toDate==`function`?e.sent_at=e.sent_at.toDate().toISOString():e.sent_at&&e.sent_at.seconds&&(e.sent_at=new Date(e.sent_at.seconds*1e3).toISOString())});let a=r.length,o=r.filter(e=>e.status===`success`).length,s=a>0?(o/a*100).toFixed(1):`100.0`,c=r[0]||null;e.innerHTML=`
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: var(--space-md); margin-bottom: var(--space-md);">
            ...
            <div class="kpi-card" style="background: var(--bg-elevated); padding: var(--space-lg); border-radius: 6px; border: 1px solid var(--border-subtle); display: flex; flex-direction: column; justify-content: space-between;">
              ...
              <div style="font-size: 0.8rem; color: var(--text-secondary); margin-top: var(--space-3xs);">
                ${c?(e=>{let t=new Date(e),n=new Date-t,r=Math.floor(n/6e4),i=Math.floor(n/36e5),a=Math.floor(n/864e5);return r<1?`Agora mesmo`:r<60?`Há ${r} min`:i<24?`Há ${i} h`:a===1?`Ontem`:a<30?`Há ${a} dias`:t.toLocaleDateString(`pt-BR`)})(c.created_at||c.sent_at):`Nenhum dado`}
              </div>
            </div>
          </div>
      ...
      `;let l=e.querySelector(`#email-tbody`),u=e.querySelector(`#results-count`),d=e.querySelector(`#manual-dispatch-modal`),f=e.querySelector(`#log-details-modal`);e.querySelector(`#open-dispatch-modal-btn`).addEventListener(`click`,()=>{d.style.display=`flex`,e.querySelector(`#manual-dispatch-form`).reset()}),e.querySelector(`#close-dispatch-modal-btn`).addEventListener(`click`,()=>{d.style.display=`none`}),e.querySelector(`#close-details-modal-btn`).addEventListener(`click`,()=>{f.style.display=`none`}),[d,f].forEach(e=>{e.addEventListener(`click`,t=>{t.target===e&&(e.style.display=`none`)})});let p=null,m=async(t,n,r)=>{if(!t){alert(`Não é possível reenviar: id da obra indisponível.`);return}if(!confirm(`Deseja reenviar a newsletter da obra "${n}" para todos os assinantes ativos?`))return;let i=r.innerText;r.disabled=!0,r.innerText=`Enviando...`,r.style.opacity=`0.5`;try{let{data:r,error:i}=await C.functions.invoke(`sendNewsletter`,{body:{poemId:t}});if(i)throw i;alert(`Newsletter para "${n}" reenviada com sucesso para ${r?.count||0} assinantes!`),f.style.display=`none`,this.renderEmailHistory(e)}catch(e){console.error(`Erro ao reenviar:`,e);let t=``;if(e.context&&typeof e.context.json==`function`)try{let n=await e.context.json();t=n.error||n.message||``}catch{}alert(`Erro ao enviar newsletter:\n${t||e.message||`Erro na Edge Function`}`),r.disabled=!1,r.innerText=i,r.style.opacity=`1`}};e.querySelector(`#resend-from-modal-btn`).addEventListener(`click`,async e=>{e.preventDefault(),p&&p.poem_id&&await m(p.poem_id,p.poems?.title||`Desconhecido`,e.currentTarget)});let h=t=>{if(u.innerText=t.length,t.length===0){l.innerHTML=`
          ...
          `;return}l.innerHTML=t.map(e=>{let t=e.poems?.title||`Desconhecido`,n=e.created_at||e.sent_at,r=n?new Date(n).toLocaleString(`pt-BR`,{dateStyle:`short`,timeStyle:`short`}):`N/A`,i=e.status===`success`?`
            ...
            `,a=`<span style="padding: 0.2rem 0.5rem; background: var(--bg-secondary); border: 1px solid var(--border-subtle); border-radius: 4px; font-size: 0.75rem; color: var(--text-secondary); text-transform: uppercase; letter-spacing: 0.5px;">${e.type===`individual`?`Individual`:e.type===`newsletter`?`Newsletter`:`Desconhecido`}</span>`,o=e.details?e.details.length>50?`${S(e.details.slice(0,48))}...`:S(e.details):`-`;return`
            <tr style="border-bottom: 1px solid var(--border-subtle); transition: background-color var(--transition-fast);">
              ...
              <td style="padding: var(--space-md) 0; font-family: var(--font-ui);">${a}</td>
              <td style="padding: var(--space-md) 0; font-family: var(--font-ui); color: var(--text-secondary); font-size: 0.85rem;">${r}</td>
              <td style="padding: var(--space-md) 0;">${i}</td>
              <td style="padding: var(--space-md) 0; font-family: var(--font-ui); font-size: 0.85rem; color: var(--text-muted); max-width: 250px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">${o}</td>
              <td style="padding: var(--space-md) 0; text-align: right; font-family: var(--font-ui);">
          ...
          `}).join(``),l.querySelectorAll(`tr`).forEach(e=>{e.style.transition=`background-color var(--transition-fast)`,e.addEventListener(`mouseenter`,()=>{e.style.backgroundColor=`var(--bg-secondary)`}),e.addEventListener(`mouseleave`,()=>{e.style.backgroundColor=`transparent`})}),l.querySelectorAll(`.view-details-btn`).forEach(n=>{n.addEventListener(`click`,()=>{let r=n.dataset.id,i=t.find(e=>e.id===r);if(!i)return;p=i,e.querySelector(`#detail-poem-title`).innerText=i.poems?.title||`Desconhecido`;let a=i.type===`individual`?`Individual${i.target_email?` (${i.target_email})`:``}`:i.type===`newsletter`?`Newsletter`:`Desconhecido`;e.querySelector(`#detail-type`).innerText=a;let o=i.created_at||i.sent_at;e.querySelector(`#detail-date`).innerText=o?new Date(o).toLocaleString(`pt-BR`,{dateStyle:`long`,timeStyle:`medium`}):`Desconhecida`;let s=i.status===`success`;e.querySelector(`#detail-status-badge`).innerHTML=s?`<span style="padding: 0.2rem 0.6rem; border-radius: 20px; font-family: var(--font-ui); font-size: 0.7rem; font-weight: 600; border: 1px solid rgba(58, 140, 84, 0.3); background: rgba(58, 140, 84, 0.08); color: var(--success); text-transform: uppercase;">Sucesso</span>`:`<span style="padding: 0.2rem 0.6rem; border-radius: 20px; font-family: var(--font-ui); font-size: 0.7rem; font-weight: 600; border: 1px solid rgba(204, 74, 74, 0.3); background: rgba(204, 74, 74, 0.08); color: var(--error); text-transform: uppercase;">Falha</span>`,e.querySelector(`#detail-description`).innerText=i.details||`Nenhum detalhe adicional disponível.`;let c=e.querySelector(`#resend-from-modal-btn`);i.poem_id?(c.style.display=`inline-block`,c.innerText=s?`Disparar Novamente`:`Tentar Reenviar`):c.style.display=`none`,f.style.display=`flex`})}),l.querySelectorAll(`.resend-log-btn`).forEach(e=>{e.addEventListener(`click`,t=>{t.preventDefault();let n=e.dataset.poemId,r=e.dataset.title;m(n,r,e)})})},g=e.querySelector(`#email-search`),_=e.querySelector(`#email-filter-status`),v=e.querySelector(`#email-sort`),y=()=>{let e=g.value.toLowerCase().trim(),t=_.value,n=v.value,i=[...r];e&&(i=i.filter(t=>{let n=(t.poems?.title||``).toLowerCase(),r=(t.details||``).toLowerCase();return n.includes(e)||r.includes(e)})),t!==`all`&&(i=t===`success`?i.filter(e=>e.status===`success`):i.filter(e=>e.status!==`success`)),n===`newest`?i.sort((e,t)=>new Date(t.created_at||t.sent_at)-new Date(e.created_at||e.sent_at)):n===`oldest`?i.sort((e,t)=>new Date(e.created_at||e.sent_at)-new Date(t.created_at||t.sent_at)):n===`title-az`?i.sort((e,t)=>{let n=e.poems?.title||``,r=t.poems?.title||``;return n.localeCompare(r)}):n===`title-za`&&i.sort((e,t)=>{let n=e.poems?.title||``;return(t.poems?.title||``).localeCompare(n)}),h(i)};g.addEventListener(`input`,w(y,150)),_.addEventListener(`change`,y),v.addEventListener(`change`,y),y(),e.querySelector(`#manual-dispatch-form`).addEventListener(`submit`,async t=>{t.preventDefault();let n=e.querySelector(`#dispatch-poem-select`),r=n.value,i=n.options[n.selectedIndex].text,a=e.querySelector(`#dispatch-target-email`),o=a?a.value.trim():``,s=e.querySelector(`#dispatch-confirm-chk`);if(!o&&!s.checked){alert(`Você precisa confirmar o envio para todos os assinantes caso não preencha um e-mail de destino.`);return}let c=e.querySelector(`#submit-dispatch-btn`),l=e.querySelector(`#close-dispatch-modal-btn`);c.disabled=!0,c.innerText=`Enviando...`,n.disabled=!0,a&&(a.disabled=!0),s.disabled=!0,l.style.display=`none`;try{let t={poemId:r};o&&(t.targetEmail=o);let{data:n,error:a}=await C.functions.invoke(`sendNewsletter`,{body:t});if(a)throw a;alert(o?`Newsletter para "${i}" enviada com sucesso para o e-mail: ${o}!`:`Newsletter para "${i}" enviada com sucesso para ${n?.count||0} assinantes!`),n?.logError&&(console.error(`Log error:`,n.logError),alert(`ATENÇÃO: Os emails foram enviados, mas houve um erro ao salvar o histórico no banco de dados.\nErro: ${n.logError.message||JSON.stringify(n.logError)}`)),d.style.display=`none`,this.renderEmailHistory(e)}catch(e){console.error(`Erro na Edge Function:`,e);let t=``;if(e.context&&typeof e.context.json==`function`)try{let n=await e.context.json();t=n.error||n.message||``}catch{}alert(`Erro ao disparar newsletter:\n${t||e.message||`Erro inesperado`}`),c.disabled=!1,c.innerText=`Disparar Newsletter`,n.disabled=!1,a&&(a.disabled=!1),s.disabled=!1,l.style.display=`inline-block`}})}catch(t){console.error(t),e.innerHTML=`<div class="error">Erro ao carregar dados do histórico: ${t.message}</div>`}},async renderSubscribers(e){e.innerHTML=`<div class="loading">Carregando assinantes...</div>`;let{data:t,error:n}=await C.from(`subscribers`).select(`id, email, active, created_at, unsubscribed_at`).order(`created_at`,{ascending:!1});if(n){e.innerHTML=`<div class="error">Erro ao carregar: ${n.message}</div>`;return}if(!t||t.length===0){e.innerHTML=`<p>Nenhum assinante encontrado.</p>`;return}let r=t.filter(e=>e.active).length,i=t.length,a=new Date;a.setDate(a.getDate()-30);let o=t.filter(e=>new Date(e.created_at)>a).length,s=t.filter(e=>!e.active&&e.unsubscribed_at&&new Date(e.unsubscribed_at)>a).length;e.innerHTML=`
      ...
      <tr style="border-bottom: 1px solid var(--border-subtle); transition: background-color var(--transition-fast);">
        ...
        <td style="padding: var(--space-md) 0; text-align: right;">
          <button class="toggle-subscriber-btn" data-id="${e.id}" data-active="${e.active}" style="font-size: 0.75rem; padding: 0.2rem 0.5rem; background: transparent; border: 1px solid var(--border-strong); color: var(--text-primary); border-radius: 2px; cursor: pointer; transition: background var(--transition-fast);">
...
`),n=encodeURI(e),r=document.createElement(`a`);r.setAttribute(`href`,n),r.setAttribute(`download`,`assinantes_${new Date().toISOString().split(`T`)[0]}.csv`),document.body.appendChild(r),r.click(),document.body.removeChild(r)}),e.querySelector(`#add-subscriber-btn`)?.addEventListener(`click`,async()=>{let n=prompt(`Digite o e-mail do assinante para cadastrar:`);if(!n||!n.includes(`@`)){n!==null&&alert(`E-mail inválido.`);return}if(t.find(e=>e.email===n)){alert(`Este e-mail já está cadastrado.`);return}let r={email:n,active:!0,created_at:new Date().toISOString()},{error:i}=await C.from(`subscribers`).insert(r);i?alert(`Erro ao cadastrar assinante: `+i.message):this.renderSubscribers(e)}),e.querySelectorAll(`.toggle-subscriber-btn`).forEach(t=>{t.addEventListener(`click`,async()=>{let n=t.dataset.id,r=t.dataset.active===`true`,i=!r;t.disabled=!0,t.innerText=`Processando...`;let a={active:i};a.unsubscribed_at=i?null:new Date().toISOString();let{error:o}=await C.from(`subscribers`).update(a).eq(`id`,n);o?(alert(`Erro ao atualizar status: `+o.message),t.disabled=!1,t.innerText=r?`Inativar`:`Ativar`):this.renderSubscribers(e)})})},async renderComments(e){e.innerHTML=`<div class="loading">Carregando comentários...</div>`;let{data:t,error:n}=await C.from(`poem_comments`).select(`id, author_name, content, approved, created_at, poems(title)`).order(`created_at`,{ascending:!1});if(n){e.innerHTML=`<div class="error">Erro ao carregar: ${n.message}</div>`;return}if(!t||t.length===0){e.innerHTML=`<p>Nenhum comentário encontrado.</p>`;return}e.innerHTML=`
      <table style="width: 100%; border-collapse: collapse; text-align: left;">
        <thead>
          <tr style="border-bottom: 1px solid var(--border-strong); color: var(--text-secondary); font-family: var(--font-ui); font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px;">
